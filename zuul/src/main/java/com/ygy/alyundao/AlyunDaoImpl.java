...
public class AlyunDaoImpl implements AlyunDao {
    ...
    public boolean message(String number) throws Exception {
        ...
        request.setPhoneNumbers("13572811105");
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("岳国裕");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_136475172");
...
//请求成功
    ...
    @Override
    public int addMessage(String number) {
        final double t = Math.random();
        final int code = (int) (t * 100000);
        //设置超时时间-可自行调整
        System.setProperty("sun.net.client.defaultConnectTimeout", "50000");
        System.setProperty("sun.net.client.defaultReadTimeout", "50000");
//初始化ascClient需要的几个参数
